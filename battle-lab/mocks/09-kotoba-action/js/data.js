...
// 勝因/敗因の「やさしい解説」（endKind をキー。新しい言葉は使わずに説明する）
// 勝ち系（zawameki / todoke / silence）＝何がうまくいったか
// 負け系（kokoro）＝なぜ失敗したか＋次どうすればよいか
var ADVICE = {
  zawameki:'ちょうどいいタイミングで言葉を届けられました。先生のざわめき（落ち着かなさ）が、すっと静まりました。',
  todoke:  '三度つづけて、まんなかで言葉を届けられました。早すぎず、遅すぎず。届け方が、ちゃんと伝わりました。',
  silence: '先生の警戒がなくなったあと、あえて何も言わずに待ちきりました。だまるのが正解のときもある、いちばん静かな届け方でした。',
  kokoro:  '読めない言葉と急かしが重なって、Lのこころがすり減りました。次は、動く印が「まんなか」に来たときに押しましょう。早すぎると急かして警戒が上がり、遅すぎると届きません。あぶないときは「だまる」で待つのも手です。'
};
// リトライ時の短い助言
var RETRY_HINT = 'ヒント：印がまんなかに来たしゅんかんに「いま！」。あせって早く押すと急かしてしまいます。';
