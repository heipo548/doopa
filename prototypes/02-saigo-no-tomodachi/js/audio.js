...
const SE = {
  ...
  heal()   { tone(523, 0.16, "sine", 0.10); tone(784, 0.24, "sine", 0.10, _t(0.06)); }, // すくうHP回復のあたたかさ
};
...
const BGM_SCALES = {
  // 夜：暗いだけにせず“やさしい子守唄”ふうに（ちいかわ的な、かわいくて少し切ない夜）。
  night: [220.0, 261.63, 293.66, 329.63, 392.0],  // Aマイナーペンタトニック（あたたかい暗さ）
